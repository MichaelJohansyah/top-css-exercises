...
### Self Check
- Did you properly chain class selectors for each rule? Yep by continuing the class selector without spaces
- Does the `proportioned` image retain its original square proportions? yesz
- Does the `distorted` image end up looking squished and, well, distorted? yezzs
